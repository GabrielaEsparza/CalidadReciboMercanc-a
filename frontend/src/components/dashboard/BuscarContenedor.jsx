...
export default function BuscarContenedor({ alRegresar }) {
  const [idContenedor, setIdContenedor] = useState("");

  const manejarBusqueda = (e) => {
    e.preventDefault();
    console.log("Buscando contenedor:", idContenedor);
    // Aquí irá la lógica para avanzar al paso de "Equipo" más adelante
  };
  ...
  return (
    <main className="p-8 max-w-[1400px] w-full mx-auto space-y-6 text-gray-800">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        {/* COLUMNA IZQUIERDA: Formulario de Escaneo */}
        <div className="lg:col-span-2 bg-white rounded-xl border border-gray-100 overflow-hidden shadow-sm">
          ...
          <form onSubmit={manejarBusqueda} className="p-6 space-y-3">
            ...
            <div className="flex gap-3">
              ...
              <button 
                type="submit"
                className="bg-slate-300 hover:bg-slate-400 text-white font-bold px-6 rounded-xl text-xs transition-colors shadow-sm tracking-wide"
              >
                Buscar
              </button>
            </div>
        ...
        {/* COLUMNA DERECHA: Vista de Producto e Instructivo */}
        <div className="space-y-6">
          
          {/* Tarjeta de Espera del Contenedor */}
          ...
          {/* Tarjeta Amarilla: Tip de Escaneo */}
