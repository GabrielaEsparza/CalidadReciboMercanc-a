    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Contenedores", x => x.NumeroContenedor);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrdenesDeCompra", x => x.NumeroDeOrden);
                    table.ForeignKey(
                        name: "FK_OrdenesDeCompra_Contenedores_NumeroContenedor",
                        column: x => x.NumeroContenedor,
                        principalTable: "Contenedores",
                        principalColumn: "NumeroContenedor",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recepciones_Contenedores_NumeroContenedor",
                        column: x => x.NumeroContenedor,
                        principalTable: "Contenedores",
                        principalColumn: "NumeroContenedor",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrdenesDeCompra_NumeroContenedor",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recepciones_NumeroContenedor",
                table: "Recepciones",
                column: "NumeroContenedor",
                unique: true);
